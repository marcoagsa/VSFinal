...
public class jogo extends AppCompatActivity {
    ...
    private GifImageView Gif, Ataques1, Ataques2;
    ...
    private void SeekBars() {
        ...
        sk1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                Ataques1.setImageResource(0);
                Ataques2.setImageResource(0);
    ...
    public void Tipoletra(TextView fight) {
    ...
    private void Verifica() {
        ...
        if (HBet == totalmoedas) {
            Tround(R.string.YW);
            Bar2();
            Ataques2.setImageResource(Ataques[randomNum]);
            tentativas++;
        } else if (ABet == totalmoedas) {
            Tround(R.string.YL);
            Bar();
            Ataques1.setImageResource(Ataques[randomNum]);
            tentativas++;
        } else{
            Tround(R.string.NW);
            tentativas++;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ataques1 = (GifImageView) findViewById(R.id.Ataques1);
        Ataques2 = (GifImageView) findViewById(R.id.Ataques2);
